...
public class PancController {
    ...
    @PostMapping
    public ResponseEntity<PancResponseDTO> criarPanc(@RequestBody PancRequestDTO pancRequest) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PancResponseDTO> atualizarPanc(@PathVariable String id, @RequestBody PancRequestDTO pancRequest) {
